...
Решением данной лабораторной работы является данные сайт (url: _<https://slw0000.github.io>_), на котором есть как персональная информация (портфолио), так и в будущем будут повяляться отчёты по лабораторным работам
